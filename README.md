...
The Export options *should* export all relevant data for that record type for the same purpose, but has not been tested to ensure syntax is always correct, since I have not used it. Empty filter lines included as none or null. Bug reports welcome. 
